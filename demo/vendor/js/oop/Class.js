...
oop.class.prototype = {
    ...
    build: function(_prototype){
        return this.clone(_prototype, {_mtd_: { type:"oop.class", buildable:true }});
    },
	...
	factory: function(){
		...
		var _class = function(){
			if(this._mtd_.buildable){
                oop.class.prototype.trigger('preConstruct', this, arguments);
                if(this.construct) this.construct.apply(this, arguments);
                oop.class.prototype.trigger('posConstruct', this, arguments);
            }
		};
