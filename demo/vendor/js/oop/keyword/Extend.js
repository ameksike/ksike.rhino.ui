 ...
 * @dependencies: oop.class
 * @made: 08/12/2010
 * @update: 09/05/2014
 * @license: LGPL v2
 *
 */
oop.class.prototype.keyword.extend = function(_class, _prototype){};
oop.class.prototype.build = function(_prototype){
    var _pro = false;
    ...
    _pro._mtd_= { type:"oop.class", buildable:true };
    if(_pro.parent) _prototype.parent = _pro.parent;
    this.clone(_prototype, _pro);
    return _pro;
}
oop.class.prototype.overloadFunction = function(_value, _owner){
...
oop.class.prototype.scp = function(_key, _owner, _params){
